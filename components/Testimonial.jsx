    ...
    return (
        <>
            <section className="pt-20 pb-20 lg:pt-[120px] lg:pb-[120px]">
                <h1 className="mb-4 uppercase text-center font-oswald font-bold leading-none tracking-tight text-gray-900 text-1xl md:text-2xl lg:text-4xl dark:text-black">Love from Our Customers</h1>
                <p className="mb-4 text-center dark:text-black">Hear What They Have to Say About Our Exquisite Collections</p>
                                        ...
                                        <SwiperSlide key={i}>
                                            ...
                                            <div className="flex justify-center">
                                                <div className="relative w-full md:w-11/12 lg:w-10/12 xl:w-8/12 p-10 bg-white rounded-lg border shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
                                                    <div className="w-full items-center md:flex">                   <div className="relative mb-12 w-full max-w-[310px] md:mr-12 md:mb-0 md:max-w-[250px] lg:mr-14 lg:max-w-[280px] 2xl:mr-16">                        <img src={image} alt="image" className="w-full rounded-lg" />
                                                        <span className="absolute -bottom-6 -right-6 z-[-1]">                           <svg
                                                            width="64"
                                                            height="64"
                                                            viewBox="0 0 64 64"
                                                            fill="none"
