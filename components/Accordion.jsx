...
const Accordion = () => {
    const [accordions, setAccordion] = useState([
        ...
        {
            key: 4,
            title: 'How can I care for and maintain my jewelry to ensure its longevity?',
    ...
    return (
        <div>
            <div className="p-2 m-8">
                <h1 className="mb-4 text-center font-oswald font-bold leading-none tracking-tight text-gray-900 text-[2rem] md:text-2xl lg:text-4xl dark:text-black"> Frequently Asked Questions</h1>
                <p className="mb-4 text-center dark:text-black">Everything You Need to Know Before Making Your Purchase</p>
